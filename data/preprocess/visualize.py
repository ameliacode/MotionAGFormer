...
def read_h36m(args):
    ...
    sample_joint_seq = read_pkl(
        "./data/keypoints/H36M-243/test/%08d.pkl" % args.sequence_number
    )[
        "data_label"
    ]  # this can be changed
...
def read_mpi(args):
    ...
    dataset_args = DatasetArgs("./data/keypoints/", 243, 81, False)
...
def main():
    ...
    ani.save(f"./data/{args.dataset}_pose{args.sequence_number}.gif")
