...
def arg_parse():
    ...
    parser.add_argument(
        "--nms-thresh", dest="nms_thresh", type=float, default=0.4, help="NMS Threshold"
    )
    parser.add_argument(
        "--reso",
        dest="reso",
    ...
    parser.add_argument(
        ...
        "--weight-file",
        type=str,
        default="demo/lib/checkpoint/yolov3.weights",
    ...
    parser.add_argument(
        ...
        "--cfg-file",
        type=str,
        default=cur_dir + "/cfg/yolov3.cfg",
        help="weight file",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "-v", "--video", type=str, default="camera", help="The input video path"
    )
    parser.add_argument(
        "-i",
        "--image",
        type=str,
        default=cur_dir + "/data/dog-cycle-car.png",
